const DefaultSettings = {
    ...
    "bosses": [
        ...
        // 亚伦南部
{huntingZoneId:   2,   templateId: 1271, name: "[2-1271] 阿勒坤(西部砍伐區)"},
{huntingZoneId:   3,   templateId: 1271, name: "[3-1271] 阿勒坤(遺忘森林)"},
{huntingZoneId:   5,   templateId: 1271, name: "[5-1271] 阿勒坤(候季安保護區)"}, // 候季安濕地
{huntingZoneId:   6,   templateId: 1271, name: "[6-1271] 阿勒坤(咆哮侵略地)"},
{huntingZoneId:   7,   templateId: 1271, name: "[7-1271] 阿勒坤(永恆盆地)"}, // 學識丘陵
        ...
        {huntingZoneId:  29,   templateId: 1272, name: "[29-1272] 艾沙特(古代森林)"},
...
{huntingZoneId:  35,   templateId: 1271, name: "[35-1271] 巴亞斯(古龍峽谷)"}, // 掠奪荒野
{huntingZoneId:  36,   templateId: 1271, name: "[36-1271] 巴亞斯(驅逐者溪谷)"}, // 驅逐者之塔
{huntingZoneId:  38,   templateId: 1271, name: "[37-1271] 巴亞斯(古代戰爭廢墟)"},

{huntingZoneId:  40,   templateId: 1271, name: "[40-1271] 潘奈巴(隔離區)"},
{huntingZoneId:  41,   templateId: 1271, name: "[41-1271] 潘奈巴(野蠻溪谷)"},

        // 夏拉北部
{huntingZoneId:  45,   templateId: 1271, name: "[45-1271] 洛堤卡(青空溪谷)"}, // 傀儡要塞
{huntingZoneId:  47,   templateId: 1271, name: "[47-1271] 洛堤卡(堤勒凱伊森林)"},

{huntingZoneId:  48,   templateId: 1271, name: "[48-1271] 海勒昆(卡諾比亞前線)"}, // 馬納安神殿

{huntingZoneId:  49,   templateId: 1271, name: "[49-1271] 洛卡農(卡勒古內雅)"},
{huntingZoneId:  50,   templateId: 1271, name: "[50-1271] 洛卡農(阿勒古內雅)"},

{huntingZoneId:  51,   templateId: 1271, name: "[51-1271] 洛亞昆(阿爾卡笛亞峽谷)"}, // 野獸高原
{huntingZoneId:  52,   templateId: 1271, name: "[52-1271] 洛亞昆(遺忘者雪原)"}, // 使者戰場
...
{huntingZoneId: 183,   templateId: 1271, name: "[183-1271] 約翰度(伊露卡)"},
{huntingZoneId: 183,   templateId: 1278, name: "[183-1278] 巴雷谷(伊露卡)"},

        // 直辖
        {huntingZoneId:  63,   templateId: 1271, name: "[貝利卡神秘商店]彼得佩依(貝利卡)"},
// {huntingZoneId:  63,   templateId: 1272, name: "[63-1272] 彼得佩依(貝利卡)"},
// {huntingZoneId:  63,   templateId: 1273, name: "[63-1273] 彼得佩依(貝利卡)"},
        {huntingZoneId:  63,   templateId: 1278, name: "[贝里克直辖领地]貝拉昆(貝利卡)"},
        {huntingZoneId:  63,   templateId: 1279, name: "[貝利卡神秘商店]彼得佩依(貝利卡)"},
// {huntingZoneId:  63,   templateId: 1280, name: "[63-1280] 彼得佩依(貝利卡)"},
        {huntingZoneId:  63,   templateId: 1281, name: "[63-1281] 彼得佩依(貝利卡)"},
// {huntingZoneId:  63,   templateId: 2950, name: "[63-2950] 彼得佩依(貝利卡)"},
// {huntingZoneId:  63,   templateId: 2951, name: "[63-2951] 彼得佩依(貝利卡)"},
// {huntingZoneId:  63,   templateId: 2952, name: "[63-2952] 彼得佩依(貝利卡)"},

{huntingZoneId:  72,   templateId: 1271, name: "[72-1271] 修墨斯克(爾雷曼西亞)"},
{huntingZoneId:  72,   templateId: 1278, name: "[72-1278] 阿爾魯瑪(爾雷曼西亞)"},

{huntingZoneId:  84,   templateId: 1271, name: "[84-1271] 凱爾門拉依特(凱亞多勒)"},
{huntingZoneId:  84,   templateId: 1278, name: "[84-1278] 凱依德拉(凱亞多勒)"},
