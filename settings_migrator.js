const DefaultSettings = {
    ...
    "bosses": [
        ...
        // 贝里卡
        {huntingZoneId:   2,   templateId: 1271, name: "[流浪商人] 阿勒坤(西部砍伐區)"},
        {huntingZoneId:   3,   templateId: 1271, name: "[流浪商人] 阿勒坤(遺忘森林)"},
        {huntingZoneId:   5,   templateId: 1271, name: "[流浪商人] 阿勒坤(候季安保護區)"}, // 候季安濕地
        {huntingZoneId:   6,   templateId: 1271, name: "[流浪商人] 阿勒坤(咆哮侵略地)"},
        {huntingZoneId:   7,   templateId: 1271, name: "[流浪商人] 阿勒坤(永恆盆地)"}, // 學識丘陵

        {huntingZoneId:   4,   templateId: 1271, name: "[流浪商人] 依托羅(爆炎山脈)"},
        {huntingZoneId:   9,   templateId: 1271, name: "[流浪商人] 依托羅(貪婪溪谷)"}, // 貪欲的黃金神殿
        {huntingZoneId:  10,   templateId: 1271, name: "[流浪商人] 依托羅(蛇之島)"},
        {huntingZoneId:  11,   templateId: 1271, name: "[流浪商人] 依托羅(荒涼海岸)"}, // 海賊巢窟
        {huntingZoneId:  12,   templateId: 1271, name: "[流浪商人] 依托羅(絕望之島)"}, // 迷霧之島

        {huntingZoneId:  15,   templateId: 1271, name: "[流浪商人] 波雷塔(狂氣丘陵)"}, // 狂怒丘陵
        {huntingZoneId:  16,   templateId: 1271, name: "[流浪商人] 波雷塔(凡貝爾丘陵)"},
        {huntingZoneId:  17,   templateId: 1271, name: "[流浪商人] 波雷塔(帕拉諾峽谷)"},
        {huntingZoneId:  23,   templateId: 1271, name: "[流浪商人] 波雷塔(月之湖)"},

        {huntingZoneId:  18,   templateId: 1271, name: "[流浪商人] 菲亞圖(遺忘巨人之都)"},
        {huntingZoneId:  19,   templateId: 1271, name: "[流浪商人] 菲亞圖(利卡諾勒曠野)"}, // 叛亂曠野
        {huntingZoneId:  21,   templateId: 1271, name: "[流浪商人] 菲亞圖(蜥蜴王巢穴)"},
        {huntingZoneId:  24,   templateId: 1271, name: "[流浪商人] 菲亞圖(黃金之路)"},

        // 尔雷曼西亚
        {huntingZoneId:  26,   templateId: 1271, name: "[流浪商人] 艾沙特(生命溪谷)"},
        ...
        {huntingZoneId:  30,   templateId: 1271, name: "[流浪商人] 貝勒沙(太陽庭院)"}, // 眾神戰場

        {huntingZoneId:  31,   templateId: 1271, name: "[流浪商人] 斯托蘭(冰凍海岸)"}, // 暴風海岸
        {huntingZoneId:  32,   templateId: 1271, name: "[流浪商人] 斯托蘭(暴君高原)"},
        {huntingZoneId:  34,   templateId: 1271, name: "[流浪商人] 斯托蘭(寒冰凍原)"},

        {huntingZoneId:  35,   templateId: 1271, name: "[流浪商人] 巴亞斯(古龍峽谷)"}, // 掠奪荒野
        {huntingZoneId:  36,   templateId: 1271, name: "[流浪商人] 巴亞斯(驅逐者溪谷)"}, // 驅逐者之塔
        {huntingZoneId:  38,   templateId: 1271, name: "[流浪商人] 巴亞斯(古代戰爭廢墟)"},

        {huntingZoneId:  40,   templateId: 1271, name: "[流浪商人] 潘奈巴(隔離區)"},
        {huntingZoneId:  41,   templateId: 1271, name: "[流浪商人] 潘奈巴(野蠻溪谷)"},


        // 凯亚多勒
        {huntingZoneId:  45,   templateId: 1271, name: "[流浪商人] 洛堤卡(青空溪谷)"}, // 傀儡要塞
        {huntingZoneId:  47,   templateId: 1271, name: "[流浪商人] 洛堤卡(堤勒凱伊森林)"},

        {huntingZoneId:  48,   templateId: 1271, name: "[流浪商人] 海勒昆(卡諾比亞前線)"}, // 馬納安神殿

        {huntingZoneId:  49,   templateId: 1271, name: "[流浪商人] 洛卡農(卡勒古內雅)"},
        {huntingZoneId:  50,   templateId: 1271, name: "[流浪商人] 洛卡農(阿勒古內雅)"},

        {huntingZoneId:  51,   templateId: 1271, name: "[流浪商人] 洛亞昆(阿爾卡笛亞峽谷)"}, // 野獸高原
        {huntingZoneId:  52,   templateId: 1271, name: "[流浪商人] 洛亞昆(遺忘者雪原)"}, // 使者戰場

        {huntingZoneId:  54,   templateId: 1271, name: "[流浪商人] 希爾貝塔(妖精森林)"},
        {huntingZoneId:  55,   templateId: 1271, name: "[流浪商人] 希爾貝塔(暗影森林)"},
        {huntingZoneId:  56,   templateId: 1271, name: "[流浪商人] 希爾貝塔(黑暗森林)"},
        {huntingZoneId:  57,   templateId: 1271, name: "[流浪商人] 希爾貝塔(阿梅納夸特拉)"},
        ...
        {huntingZoneId:  63,   templateId: 1281, name: "[流浪商人] 彼得佩依(貝利卡)"},
        {huntingZoneId:  63,   templateId: 2950, name: "[流浪商人] 彼得佩依(貝利卡)"},
        {huntingZoneId:  63,   templateId: 2951, name: "[流浪商人] 彼得佩依(貝利卡)"},
        ...
        {huntingZoneId: 182,   templateId: 1271, name: "[流浪商人] 巴雷谷(巴拉卡尼亞丘陵地)"},
        {huntingZoneId: 191,   templateId: 1271, name: "[流浪商人] 巴雷谷(帝國之地)"}
    ]
};
