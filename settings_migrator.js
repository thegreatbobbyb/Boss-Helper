const DefaultSettings = {
    ...
    "bosses": [
        ...
        {huntingZoneId:   5,   templateId: 1271, name: "[阿卡尼亞領地]阿勒坤(候季安保護區)"}, // 候季安濕地
        {huntingZoneId:   6,   templateId: 1271, name: "[阿卡尼亞領地]阿勒坤(咆哮侵略地)"},
        {huntingZoneId:   7,   templateId: 1271, name: "[阿卡尼亞領地]阿勒坤(永恆盆地)"}, // 學識丘陵
        ...
        {huntingZoneId:  35,   templateId: 1271, name: "[比亞艾雷尼溫領地]巴亞斯(古龍峽谷)"}, // 掠奪荒野
        {huntingZoneId:  36,   templateId: 1271, name: "[比亞艾雷尼溫領地]巴亞斯(驅逐者溪谷)"}, // 驅逐者之塔
        ...
        // 夏拉北部
        {huntingZoneId:  45,   templateId: 1271, name: "[洛斯堤里奇亞領]洛堤卡(青空溪谷)"}, // 傀儡要塞
        {huntingZoneId:  47,   templateId: 1271, name: "[洛斯堤里奇亞領]洛堤卡(堤勒凱伊森林)"},

        {huntingZoneId:  48,   templateId: 1271, name: "[黑坎特別地區]海勒昆(卡諾比亞前線)"}, // 馬納安神殿

        {huntingZoneId:  49,   templateId: 1271, name: "[洛斯卡伊阿納領地]洛卡農(卡勒古內雅)"},
        {huntingZoneId:  50,   templateId: 1271, name: "[洛斯卡伊阿納領地]洛卡農(阿勒古內雅)"},

        {huntingZoneId:  51,   templateId: 1271, name: "[洛斯阿爾卡笛亞領地]洛亞昆(阿爾卡笛亞峽谷)"}, // 野獸高原
        {huntingZoneId:  52,   templateId: 1271, name: "[洛斯阿爾卡笛亞領地]洛亞昆(遺忘者雪原)"}, // 使者戰場
        ...
        {huntingZoneId:  63,   templateId: 1279, name: "[神秘商店]彼得佩依(貝利卡)"},
        {huntingZoneId:  63,   templateId: 1280, name: "[神秘商店]彼得佩依(貝利卡)"},
        {huntingZoneId:  63,   templateId: 1281, name: "[神秘商店]彼得佩依(貝利卡)"},
        {huntingZoneId:  72,   templateId: 1271, name: "[神秘商店]修墨斯克(爾雷曼西亞)"},
        {huntingZoneId:  84,   templateId: 1271, name: "[神秘商店]凱爾門拉依特(凱亞多勒)"},
        {huntingZoneId: 183,   templateId: 1271, name: "[神秘商店]約翰度(伊露卡)"}
    ]
};
